...
vi.mock('../../src/recorder/test-generator', () => ({
  generateTestCases: vi.fn(() => []),
}))

import { ActionRecorder, getGlobalRecorder, setGlobalRecorder, createRecorder } from '../../src/recorder/index'
import * as testGenerator from '../../src/recorder/test-generator'
...
describe('ActionRecorder', () => {
  ...
  it('record propagates to test-generator and appends test cases', () => {
    testGenerator.generateTestCases.mockReturnValueOnce([
