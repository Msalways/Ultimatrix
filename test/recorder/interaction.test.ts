...
import type { Interaction, TestCase, Assertion, Session } from '../../src/recorder/interaction'
...
describe('InteractionType enum', () => {
  it('has all expected values', () => {
    ...
    expect(InteractionType.API_CALL).toBe('api_call')
  })

  it('has 10 distinct values', () => {
