...
import { httpRequest, followRedirects, omitHeader } from '../../src/tools/http-tools'
import { recordTestCase } from '../../src/tools/record-test-case'
import { parseResponse, checkWaf, findEndpointsInResponse, measureTiming } from '../../src/tools/observation-tools'
import { extractSessionCookie, extractCsrfToken, useSession } from '../../src/tools/session-tools'
import { recordEvidence, writeFinding } from '../../src/tools/control-tools'
import { readAppModelSection, writeAppModelSection } from '../../src/tools/app-model-tools'
import { runRecon, frameworkFingerprint, cloudMetadataProbe } from '../../src/tools/recon-tools'
import { askUser } from '../../src/tools/interaction-tools'
import { registerAllTools, getAttackPath } from '../../src/tools/registry'
...
describe('record test case tool has correct id', () => {
  it('recordTestCase id is "recordTestCase"', () => {
    expect(recordTestCase.id).toBe('recordTestCase')
  })
})
