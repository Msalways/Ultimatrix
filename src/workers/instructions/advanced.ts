...
When you switch to a different attack type (e.g., from race conditions to business logic, from mass assignment to GraphQL), include [PATH: <type>] in your output.
