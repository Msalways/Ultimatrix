...
export const updateGraph = createTool({
  ...
  inputSchema: z.object({
    ...
    findingData: z.record(z.unknown()).optional(),
    authFlowData: z.record(z.unknown()).optional(),
    rbacData: z.record(z.unknown()).optional(),
    attackData: z.record(z.unknown()).optional(),
