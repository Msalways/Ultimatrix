      ...
      <div>
        ...
        <div className="space-y-3">
          {(!scope.allowedDomains || scope.allowedDomains.length === 0) && (
            <div className="rounded-md border border-amber-900/60 bg-amber-950/30 px-3 py-2 text-xs text-amber-400">
              No allowed domains configured. Current behavior is all domains allowed.
            </div>
          )}
